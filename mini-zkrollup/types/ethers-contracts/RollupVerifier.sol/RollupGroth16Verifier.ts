...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface RollupGroth16VerifierInterface extends Interface {
  ...
  export interface RollupGroth16Verifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): RollupGroth16Verifier;
    waitForDeployment(): Promise<this>;

    interface: RollupGroth16VerifierInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    verifyProof: TypedContractMethod<
      [_pA: [BigNumberish, BigNumberish], _pB: [[BigNumberish, BigNumberish], [BigNumberish, BigNumberish]], _pC: [BigNumberish, BigNumberish], _pubSignals: [BigNumberish, BigNumberish, BigNumberish], ],
      [boolean],
      'view'
    >

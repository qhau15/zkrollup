...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IRollupGroth16VerifierInterface extends Interface {
  ...
  export interface IRollupGroth16Verifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): IRollupGroth16Verifier;
    waitForDeployment(): Promise<this>;

    interface: IRollupGroth16VerifierInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    verifyProof: TypedContractMethod<
      [pA: [BigNumberish, BigNumberish], pB: [[BigNumberish, BigNumberish], [BigNumberish, BigNumberish]], pC: [BigNumberish, BigNumberish], pubSignals: [BigNumberish, BigNumberish, BigNumberish], ],
      [boolean],
      'view'
    >

...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface RollupVerifierAdapterInterface extends Interface {
    getFunction(nameOrSignature: "verifier" | "verifyProof"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'verifyProof', data: BytesLike): Result;
  ...
  export interface RollupVerifierAdapter extends BaseContract {
    
    connect(runner?: ContractRunner | null): RollupVerifierAdapter;
    waitForDeployment(): Promise<this>;

    interface: RollupVerifierAdapterInterface;
